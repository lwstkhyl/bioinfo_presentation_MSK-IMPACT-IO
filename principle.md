...
![Logistic3](./md-image/Logistic3.png){:width="70px" height="70px"}
...
![roc3](./md-image/roc3.png){:width="50px" height="50px"}
...
![ROC曲线2](./md-image/ROC曲线2.png){:width="200px" height="200px"}

![两种曲线](./md-image/两种曲线.png){:width="300px" height="300px"}
...
![cindex2](./md-image/cindex2.png){:width="400px" height="400px"}
...
![Brier_score](./md-image/Brier_score.png){:width="150px" height="150px"}

可视化：

![Brier_score2](./md-image/Brier_score2.png){:width="300px" height="300px"}
...
![单因素cox分析](./md-image/单因素cox分析.png){:width="100px" height="100px"}其中h<sub>0</sub>(t)为常数
...
![Survival1](./md-image/Survival1.png){:width="300px" height="300px"}
